%% # TODO 25-min Talk — Outline + Timing (NEW slide numbers)

%% ## Introduction

%% 1. **Title & authors** — 00:00–00:15
%%    *Source: old slide 1*
%% 2. **Motivation: why hylos in Rocq; benefits** — 00:15–02:30
%%    *Source: old slide 10*

%% ## Background (minimal, prioritised)

%% 3. **Folds as initial algebras** — 02:30–05:00
%%    *Source: old slides 4–5 (slide 3 optional, no new slide)*
%% 4. **Hylomorphisms (divide & conquer)** — 05:00–07:00
%%    *Source: old slide 6*
%% 5. **Folds as hylos (bridge)** — 07:00–07:30
%%    *Source: old slide 7 (optional)*

%% ## Challenges

%% 6. **Key challenges & our solutions (single slide)** — 07:30–08:30
%%    *Source: old slide 11*

%% ## Approach Overview

%% 7. **Roadmap** — 08:30–08:45
%%    *Source: old slide 12*

%% ## Part I — Containers (extractable)

%% 8. **Containers: definition + functor action** — 08:45–10:00
%%    *Source: old slide 14*
%% 9. **Example: F X = 1 + X×X (shapes/positions once)** — 10:00–11:00
%%    *Source: old slide 15*
%% 10. **Mechanising for clean extraction (`valid` + `App`)** — 11:00–13:00
%%     *Source: old slides 18–19 (use 19 as main)*

%% ## Part II — Recursive Coalgebras & Hylos (deep dive)

%% 11. **(Co)algebras & (co)fixpoints (merged)** — 13:00–14:00
%%     *Source: old slides 23+24*
%% 12. **Recursive coalgebras: `RecF` vs well-founded relation; why termination** — 14:00–17:00
%%     *Source: old slides 25–26*
%% 13. **Recursive hylomorphisms: existence/uniqueness; `hylo_def` gist** — 17:00–19:00
%%     *Source: old slide 27*
%% 14. **Hylo laws (fusion/deforest) — statement & diagram** — 19:00–20:30
%%     *Source: old slide 30*

%% ## Part III — Extraction & Examples

%% 15. **Quicksort extraction (show OCaml; mention optimisation)** — 20:30–22:30
%%     *Source: old slide 35 (mention 36)*
%% 16. **Dynamorphism/memo-table hook (DP teaser)** — 22:30–24:00
%%     *Source: old slide 37 (optionally name knapsack from 38 without code)*

%% ## Conclusion

%% 17. **Summary & future work** — 24:00–25:00
%%     *Source: old slide 40*

%% ---

%% ### Pacing checkpoints (quick refs)

%% * Leave new slide **5** by **07:30**.
%% * Start Part II (new slide **11**) by **13:00**.
%% * Be on extraction (new slide **15**) by **20:30**.
%% * If behind: skip new slide **5**; compress **8–9** into one; state **14** in one sentence; go from **15** straight to **17**.
...
%
%
\begin{frame}{Why Hylomorphisms in Rocq}
%% 2. **Motivation: why hylos in Rocq; benefits** — 00:15–02:30
%%    *Source: old slide 10*
\end{frame}

\begin{frame}{Folds as Initial Algebras}
%% 3. **Folds as initial algebras** — 02:30–05:00
%%    *Source: old slides 4–5 (slide 3 optional, no new slide)*
\end{frame}
...
\begin{frame}{Folds/Unfolds as Hylomorphisms}
%% 5. **Folds as hylos (bridge)** — 07:00–07:30
%%    *Source: old slide 7 (optional)*
\end{frame}
...
\begin{frame}{Challenges for Encoding Hylos in Rocq}
%% 6. **Key challenges & our solutions (single slide)** — 07:30–08:30
%%    *Source: old slide 11*
\end{frame}
...
\begin{frame}{Containers: Example}
%% 9. **Example: F X = 1 + X×X (shapes/positions once)** — 10:00–11:00
%%    *Source: old slide 15*
\end{frame}

\begin{frame}{Container Mechanisation for Clean Extraction}
%% 10. **Mechanising for clean extraction (`valid` + `App`)** — 11:00–13:00
%%     *Source: old slides 18–19 (use 19 as main)*
\end{frame}
...
\begin{frame}{(Co)algebras \& (co)fixpoints}
%% 11. **(Co)algebras & (co)fixpoints (merged)** — 13:00–14:00
%%     *Source: old slides 23+24*
\end{frame}

\begin{frame}{Recursive Coalgebras}
%% 12. **Recursive coalgebras: `RecF` vs well-founded relation; why termination** — 14:00–17:00
%%     *Source: old slides 25–26*
\end{frame}

\begin{frame}{Recursive Hylomorphisms}
%% 13. **Recursive hylomorphisms: existence/uniqueness; `hylo_def` gist** — 17:00–19:00
%%     *Source: old slide 27*
\end{frame}

\begin{frame}{Hylomorphism Fusion}
%% 14. **Hylo laws (fusion/deforest) — statement & diagram** — 19:00–20:30
%%     *Source: old slide 30*
\end{frame}
...
\begin{frame}{Example: Quicksort Extraction}
%% 15. **Quicksort extraction (show OCaml; mention optimisation)** — 20:30–22:30
%%     *Source: old slide 35 (mention 36)*
\end{frame}

\begin{frame}{Example: Dynamorphisms}
%% 16. **Dynamorphism/memo-table hook (DP teaser)** — 22:30–24:00
%%     *Source: old slide 37 (optionally name knapsack from 38 without code)*
\end{frame}
...
\begin{frame}
  \frametitle{Why Mechanising Hylomorphisms in Rocq?}
  ...
  \begin{itemize}
    ...
    \item On the other hand, Rocq does not capture all recursive definitions
    \item The benefits of formalising hylos in Rocq is three fold:
      \begin{itemize}
        \item Giving the Rocq programmer a \embf{library} where for most
...
\begin{frame}
  ...
  \LARGE
    ...
    \begin{sticky}%
      \vspace{-1.5em}
      \begin{tabular}{@{}rl}
        {\textbf{\color{gray}Part I:}} & Extractable Containers in Rocq \\
        {\textbf{\color{gray}Part II:}} & Recursive Coalgebras \& Rocq Hylomorphisms \\
...
\begin{frame}
  ...
  \begin{sticky}
    ...
    {\normalfont\Large Extractable Containers in Rocq}
    \par%
  \end{sticky}
  %\end{beamercolorbox}
  \vfill
  ...
  \Put(30,160){%
    ...
    \begin{greenbox}
      ...
      \begin{itemize}
        ...
        \item Rocq's extraction mechanism ignores the \coq{Prop} field.
        \item We provide a (very basic!) mechanism to help building morphisms.
        \item Building on top of setoids \& morphisms allows the  use of Rocq's
...
\begin{frame}[fragile]
  ...
  Observations:
  \begin{enumerate}
    \item UIP is \alert{not an axiom} in Rocq for types with a \alert{decidable
      equality}.
    \item If a type family is defined as a \alert{predicate subtype}, Rocq can
    ...
    \begin{greenbox}
      ...
      \begin{itemize}
        \item All proofs of the form \coq{V1 V2 : valid(s,p) = true} are
              provably equal in Rocq to \coq{eq_refl}.
...
\begin{frame}
  ...
  \begin{sticky}
    ...
    {\normalfont\Large Recursive Coalgebras \& Rocq Hylomorphisms}
    \par%
  \end{sticky}
  %\end{beamercolorbox}
  \vfill
...
\begin{frame}[fragile]
  ...
  We cannot define \coq{hylo} in Rocq using arbitrary coalgebras, because they may not exist...
...
Lemma deforest : cata a \o rana c =e hylo a c.
  ...
  \Put(40,90){%
    ...
    \begin{minipage}{.86\columnwidth}
      \small
    \begin{greenbox}
      The \ul{proofs in Rocq are almost direct copies from pen-and-paper proofs}:
...
programs by fusing simpler specifications in Rocq.
