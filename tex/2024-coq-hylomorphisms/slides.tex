...
\titlegraphic{%
  \begin{picture}(382,0)
    {\put(140,-10){\includegraphics[width=4cm]{figures/UoK_Logo.jpg}}}
  \end{picture}
  }

\title{Dynamically Updatable Multiparty Session Protocols}
\subtitle{Generating Concurrent Go Code from Unbounded Protocols}
\author{\small\textbf{David Castro-Perez} and Nobuko Yoshida}
\institute{\mailto{d.castro-perez@kent.ac.uk}}
\date{%\put(0,-60){
  \textbf{ECOOP23} \hspace{.2cm} 19-07-2023
%}
}
