...
fold a = a . fmap (fold a) . inOp
    ...
    \begin{column}{.37\textwidth}
      \begin{tikzcd}
        \mhask{f (Fix f)} \arrow[r, dotted] \arrow[d, "\mhask{In}"] 
        & \mhask{f x} \arrow[d, "\mhask{a}"] 
        \\
        \mhask{Fix f} \arrow[r, dotted] 
...
\end{tikzcd}
  ...
  \begin{tikzpicture}[overlay,remember picture]
    \node[rectangle, rounded corners, fill=yellow!80!black] at (3.2,4) 
    {\begin{tabular}{@{}c@{}}
      Least Fixed-Point  \\
      $\mhask{Fix f} \equiv \mhask{f (Fix f)}$
    \end{tabular}}; 
  \end{tikzpicture}
  \end{onlyenv}
  ...
  \begin{onlyenv}<3>
  \begin{tikzpicture}[overlay,remember picture]
    \node[rectangle, rounded corners, fill=yellow!80!black] at (9,0) (a) 
      {\haskell{f}-algebra}; 
...
\end{tikzcd}
  ...
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \draw[overlay, yellow!90!black, arrows=->, line width=.5mm]
      (ha.west) -- (pic cs:halg1);
    \draw[overlay, yellow!90!black, arrows=->, line width=.5mm]
      (ha.east) -- ($(pic cs:halg2) + (-.1, -.2)$);
  \end{tikzpicture}
  \end{onlyenv}
  ...
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \draw[overlay, yellow!90!black, arrows=->, line width=.5mm]
      (hc.west) -- (pic cs:hcoalg1);
    \draw[overlay, yellow!90!black, arrows=->, line width=.5mm]
      (hc.north) -- ($(pic cs:hcoalg2) + (-.1, -.2)$);
  \end{tikzpicture}
  \end{onlyenv}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{center}\LARGE
  \begin{tikzcd}
    \mathcal{D} \arrow[r, "\mathsf{R}"{name=F}, bend left=25] &
    \mathcal{C} \arrow[l, "\mathsf{L}"{name=G}, bend left=25]
...
\begin{frame}
  ...
  \uncover<2->{%
    Solutions (the remainder of this talk):
    \begin{enumerate}
